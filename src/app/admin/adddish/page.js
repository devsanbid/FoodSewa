        ...
        <div className="p-6">
          ...
          <nav className="space-y-2">
            ...
            <div className="ml-4 space-y-1">
              ...
              <div className="flex items-center gap-3 p-2 rounded bg-orange-900 text-orange-300">
          ...
          <div className="mt-8 p-4 bg-gray-900 rounded-lg">
            ...
            <p className="text-sm">🔥 Upgrade Your Plan. Find Out here</p>
            <button className="mt-2 text-orange-500 text-sm hover:underline">Contact Support</button>
          </div>
          ...
          <div className="mt-8 space-y-2">
            ...
            <div className="flex items-center gap-3 p-2 rounded hover:bg-gray-700 text-red-400">
