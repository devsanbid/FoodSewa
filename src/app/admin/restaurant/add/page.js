      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-gray-800 min-h-screen border-r border-gray-700 relative">
          <nav className="p-4 space-y-2 pb-32">
            <div className="flex items-center space-x-3 text-gray-300 hover:text-white hover:bg-gray-700 rounded-lg p-2 cursor-pointer">
            ...
            <div className="space-y-1">
              ...
              <div className="ml-8 space-y-1">
                <div className="text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg p-2 cursor-pointer text-sm">
                  • Restaurants List
                </div>
                <div className="text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg p-2 cursor-pointer text-sm">
                  • Restaurant Details
                </div>
                <div className="text-orange-500 bg-gray-700 rounded-lg p-2 text-sm">
                  • Add Restaurant
                </div>
                <div className="text-gray-400 hover:text-white hover:bg-gray-700 rounded-lg p-2 cursor-pointer text-sm">
                  • Edit Restaurant
          ...
          {/* Upgrade Section */}
          <div className="mx-4 mb-4 p-4 bg-gray-700 rounded-lg">
            <div className="flex items-center justify-center w-8 h-8 bg-orange-500 rounded mb-3">
              <Zap className="w-5 h-5 text-white" />
            </div>
            <div className="text-sm text-orange-400 mb-2">🔥 Upgrade Your Plan. Find Out here</div>
            <button className="w-full bg-orange-600 hover:bg-orange-700 text-white text-sm py-2 px-4 rounded">
              Contact Support
            </button>
          </div>

          {/* Bottom Navigation */}
          <div className="absolute bottom-0 left-0 right-0 p-4 space-y-2 bg-gray-800 border-t border-gray-700">
            <div className="flex items-center space-x-3 text-gray-300 hover:text-white hover:bg-gray-700 rounded-lg p-2 cursor-pointer">
              <UserCircle className="w-5 h-5" />
              <span>Profile</span>
            </div>
            <div className="flex items-center space-x-3 text-red-400 hover:text-red-300 hover:bg-gray-700 rounded-lg p-2 cursor-pointer">
