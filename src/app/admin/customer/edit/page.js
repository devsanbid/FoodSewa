      ...
      <div className={`${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 fixed lg:static inset-y-0 left-0 z-50 w-64 bg-gray-800 transition-transform duration-300 ease-in-out`}>
        ...
        <nav className="mt-8 px-4 space-y-2">
          ...
          <div>
            ...
            >
              ...
              <ChevronDown className={`w-4 h-4 transition-transform ${dropdowns.orders ? 'rotate-180' : ''}`} />
            </button>
          </div>
          ...
          <div>
            ...
            >
              ...
              <ChevronDown className={`w-4 h-4 transition-transform ${dropdowns.customers ? 'rotate-180' : ''}`} />
            </button>
            {dropdowns.customers && (
              <div className="ml-8 mt-1 space-y-1">
                <a href="#" className="block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-700 rounded">Customers List</a>
                <a href="#" className="block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-700 rounded">Customer Details</a>
                <a href="#" className="block px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-700 rounded">Add Customer</a>
                <a href="#" className="block px-3 py-2 text-sm text-orange-500 bg-gray-700 rounded">Edit Customer</a>
              </div>
            )}
          </div>
          ...
          <div>
            ...
            >
              ...
              <ChevronDown className={`w-4 h-4 transition-transform ${dropdowns.restaurants ? 'rotate-180' : ''}`} />
            </button>
          </div>
          ...
          <div>
            ...
            >
              ...
              <ChevronDown className={`w-4 h-4 transition-transform ${dropdowns.dishes ? 'rotate-180' : ''}`} />
            </button>
          </div>
          ...
          <div>
            ...
            >
              ...
              <ChevronDown className={`w-4 h-4 transition-transform ${dropdowns.sellers ? 'rotate-180' : ''}`} />
            </button>
          </div>
          ...
          <div>
            <button 
              onClick={() => toggleDropdown('extraPages')}
              className="w-full flex items-center justify-between px-3 py-2 text-gray-300 hover:bg-gray-700 rounded-lg transition-colors"
            >
              <div className="flex items-center space-x-3">
              ...
              <ChevronDown className={`w-4 h-4 transition-transform ${dropdowns.extraPages ? 'rotate-180' : ''}`} />
            </button>
          </div>
        </nav>
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-gray-700">
          <div className="bg-gray-700 rounded-lg p-3 mb-4">
            ...
            <p className="text-xs text-center text-gray-300 mb-2">🔥 Upgrade Your Plan. Find Out here</p>
            <button className="w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 rounded text-sm transition-colors">
              Contact Support
            </button>
          </div>
          ...
          <div className="space-y-2">
            ...
            <button className="w-full flex items-center space-x-3 px-3 py-2 text-red-400 hover:bg-gray-700 rounded-lg transition-colors">
